              ...
              <div id="carousel-thumb" className="carousel slide carousel-fade carousel-thumbnails mb-5 pb-4" data-ride="carousel">
                ...
                <div className="carousel-inner text-center text-md-left" role="listbox">
                  <div className="carousel-item active">
                    <img src="img/1.jpg" alt="First slide" className="img-fluid" />
                  </div>
                  <div className="carousel-item">
                    <img src="img/2.jpg" alt="Second slide" className="img-fluid" />
                  </div>
                  <div className="carousel-item">
                    <img src="img/20.jpg" alt="Third slide" className="img-fluid" />
                  </div>
                </div>
                {/*/.Slides*/}
                {/*Thumbnails*/}
                ...
                <div className="row text-center text-md-left">
                  <div className="col-md-4 col-12 ">
                    ...
                    <div className="form-group">
                      <input className="form-check-input" type="radio" value="WHITE" name="color" id="WHITE" />
                      <label For="WHITE" className="form-check-label dark-grey-text" checked={true} >White</label>
                    </div>
                  </div>
                  <div className="col-md-4">
                    {/*Radio group*/}
                    <div className="form-group">
                      <input className="form-check-input" value="SILVER" name="color" type="radio" id="SILVER" />
                      <label For="SILVER" lassName="form-check-label dark-grey-text" >Silver</label>
                    </div>
                  </div>
                  <div className="col-md-4">
                    {/*Radio group*/}
                    <div className="form-group">
                      <input className="form-check-input" name="color" type="radio" id="Gold" vlaue="Gold" />
                      <label For="Gold" className="form-check-label dark-grey-text">Gold</label>
                    </div>
                  </div>
                </div>
