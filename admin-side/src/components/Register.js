...
import { registerAdmin } from '../actions/authentication';
...
class Register extends Component {
    ...
    handleSubmit(e) {
        ...
        this.props.registerAdmin(admin, this.props.history);
    }
            ...
            <div className="col-md-10 col-lg-8 col-xl-6 form-pad bg-white logbox">
                ...
                <div className="row my-5">
                    <div className="col-6 signup-bg text-center  hoverable">
                        <Link to="/signp"><span>SIGN UP</span></Link>
                    </div>
                    ...
                    <div className="col-12 px-0">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group mb-0">
                                ...
                                <span><img src="style/img/contact.png" className="input-icon" alt="" /></span>
                            </div>
                            <div className="form-group mb-0">
                                <input
                                    type="text"
                                ...
                                />
                                <span><img src="style/img/first_Last_name.png" className="input-icon" alt="" /></span>
